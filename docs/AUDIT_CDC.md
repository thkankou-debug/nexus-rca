...
| §5 Espaces métiers (11 profils) | **11/11 livrés** (agent rhabillé le 12/09 — dernier restant) |
...
| Agent | `/dashboard/agent` | **Livré (12/09)** | Rhabillé dans le shell unique (layout, 21 pages en fragments, mes-rh sans double shell) — contenu inchangé ; Instructions accessibles via la nav commune |
