...
| P10 | Site public | 🟡 en cours — Étape 1 (E1-E4) livrée ; E1/E2 sous A1 ; E3 terminé (8 pôles, tous avec une page réelle). Amendement 08/09 (M1-M10) : maquette mobile du 07/09 rejetée. M6/M7/M8 livrés 08/09 (cible tactile langue, zoom iOS sur formulaire public, encoche header). Trouvé au passage : bascule clair/sombre exposée sur la Navbar publique, contraire à l'interdit A1 — non retirée, décision à prendre par Thierry. **Bloqué sur M2** (direction visuelle de la couverture, aucune image approuvée) avant de finir le hero. Reste : M2/M9 (vérif. device réel), E5/E7/E8, harmonisation des 12 pages — voir docs/P10_LIVRABLES.md et docs/DETTE.md | v3/integration-v3 | 08/09 |
