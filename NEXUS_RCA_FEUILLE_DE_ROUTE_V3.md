...
| P9 | Portail client | 🟡 en cours — Lot 0 (2 IDOR réelles corrigées sur `/api/devis\|factures/[id]/pdf`, aucun contrôle client avant) et Lot 1 (consultation/acceptation devis par le client, migration 069, instantané figé dans `audit_log`) livrés 07/09. Restent : Lot 2 (factures/reçus téléchargeables), Lot 3 (documents officiels délivrés), Lot 4 (corrections structurées, probablement 0 code — `demande_documents_requests` existant suffit) — voir docs/DETTE.md | v3/integration-v3 | 07/09 |
| P10 | Site public | ⬜ | | |
