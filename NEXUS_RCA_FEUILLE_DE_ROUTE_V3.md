...
| P10 | Site public | 🟡 en cours — Étape 1 (E1-E4) livrée ; E1/E2 sous A1 ; E3 terminé (8 pôles, tous avec une page réelle). Amendement 08/09 (M1-M10) : maquette mobile du 07/09 rejetée. M6/M7/M8 livrés (cible tactile langue, zoom iOS formulaire public, encoche header). Bascule clair/sombre retirée de la Navbar publique (décision Thierry) ; bug plus large trouvé et corrigé au passage : mode sombre auto-détecté s'appliquait sur tout le site public via `app/layout.tsx`, rendait illisibles les cartes ivoire des 2 nouvelles pages — script limité à `/dashboard`. M2 tranché : pas d'image pour l'instant. Reste : M9 (vérification sur device réel), E5/E7/E8, harmonisation des 12 pages existantes — voir docs/P10_LIVRABLES.md et docs/DETTE.md | v3/integration-v3 | 08/09 |
