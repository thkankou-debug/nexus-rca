...
| P9 | Portail client | 🟡 en cours — Lot 0 (2 IDOR corrigées sur les PDF devis/factures), Lot 1 (devis) et Lot 2 (factures + reçus téléchargeables, migration 070, durcissement de `send-receipt` au passage) livrés 07/09. Restent : Lot 3 (documents officiels délivrés — décision en attente : colonne `uploaded_by_role` ou `categorie` dédiée), Lot 4 (corrections structurées, probablement 0 code) — voir docs/DETTE.md | v3/integration-v3 | 07/09 |
| P10 | Site public | ⬜ | | |
