...
| P10 | Site public | 🟡 en cours — Étape 1 (E1-E4) livrée 07/09 ; décisions de Thierry reçues et E1/E2 exécutés (token ivoire + migration or Hero/FinalCTA/PublicHero, sous A1). Reste : E3 (pages `accompagnement-business` et `reseau-international`, CMS réel), E6 (maquette mobile dérivée de la desktop, à valider), E5/E7/E8 (données institutionnelles, bloqué sur Thierry) — voir docs/P10_LIVRABLES.md | v3/integration-v3 | 07/09 |
