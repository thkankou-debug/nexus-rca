...
| P8 | CMS et contenus | 🟡 en cours — inventaire slug↔pôle confirmé, `services` peuplée (12 lignes), écrans "Services et tarifs" et "FAQ" livrés ; is_verified/is_published ajoutées à agency_settings/temoignages/partenaires ; nouvelle adresse Bangui (Croisement Marabena) corrigée dans 21 fichiers + 1ère ligne réelle dans `bureaux` ; reste : Partenaires, Témoignages, Pays & destinations, Bureaux (écran), Informations institutionnelles, Contenus de page — voir docs/DETTE.md | v3/integration-v3 | 06/09 |
| P9 | Portail client | ⬜ | | |
| P10 | Site public | ⬜ | | |
