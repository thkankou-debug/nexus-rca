...
| P8 | CMS et contenus | 🟡 en cours — écrans "Services et tarifs", "FAQ", "Témoignages", "Partenaires" (+ upload logo), "Pays & destinations", "Bureaux" et "Informations institutionnelles" tous livrés ; `services` peuplée (12 lignes réelles) ; nouvelle adresse Bangui (Croisement Marabena) corrigée dans 21 fichiers + bureau réel en base ; reste : Contenus de page (`contenus_site`) — voir docs/DETTE.md | v3/integration-v3 | 06/09 |
| P9 | Portail client | ⬜ | | |
| P10 | Site public | ⬜ | | |
