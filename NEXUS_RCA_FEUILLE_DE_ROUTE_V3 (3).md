...
| P6 | Finance | 🟡 en cours — D5 (migration PDF jsPDF → pdf-lib, 5 fichiers) et numérotation par séquence (DEV-/FAC-/REC-) terminées ; lots Devis, Factures, Sessions caisse, Catégories comptables/Commissions et Échéanciers (reste dû) terminés, PDF devis/factures vérifiés visuellement par Thierry le 06/09 — OK ; reste à faire : rapprochement, validation, rapports — voir docs/DETTE.md | v3/integration-v3 | 06/09 |
| P8 | CMS et contenus | ⬜ | | |
| P9 | Portail client | ⬜ | | |
| P10 | Site public | ⬜ | | |
