...
| P6 | Finance | 🟡 en cours — D5 (migration PDF jsPDF → pdf-lib, 5 fichiers) et numérotation par séquence (DEV-/FAC-/REC-) terminées ; lot Devis (CRUD, cycle de vie, PDF) terminé, non vérifié visuellement ; PDF des lots précédents toujours en attente de vérification visuelle par Thierry ; reste à faire : factures, sessions caisse, catégories comptables et commissions, rapprochement/validation/rapports — voir docs/DETTE.md | v3/integration-v3 | 06/09 |
| P8 | CMS et contenus | ⬜ | | |
| P9 | Portail client | ⬜ | | |
| P10 | Site public | ⬜ | | |
