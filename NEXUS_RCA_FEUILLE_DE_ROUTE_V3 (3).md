...
| P9 | Portail client | ⬜ | | |
| P10 | Site public | 🟡 en cours — 1ère version homepage rejetée par Thierry (07/09) pour non-conformité à la maquette ; refonte corrective livrée le même jour : logo institutionnel (N or, demande explicite), navbar blanche dès chargement sur la home + nav réduite (1 seul CTA), hero 2 colonnes serif + visuel SVG réseau international (Bangui/Europe/Amériques/Moyen-Orient/Asie, pas de photo), TrustBar, 8 piliers tous branchés CMS (migration 067), passage à l'or étendu à TrustMarquee/IdentityStatement/HowItWorks. En attente de la revalidation visuelle de Thierry (captures desktop 1680×945 et 1366×768 transmises ; vérification mobile réelle demandée à Thierry, capture automatisée non fiable sur cet environnement — voir docs/DETTE.md). Reste ensuite : les 2 piliers en dur pour le lien (business/réseau, pas de page dédiée), factorisation des 12 pages services, E4 (photo réelle), E5 (perf), E6 (zone sécurité), E7 (bilingue) — voir docs/DETTE.md | v3/integration-v3 | 07/09 |
