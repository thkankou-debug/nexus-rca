...
export default function FinancementPage() {
  ...
  // Cas types — 3 cards stratégiques (factuel, pas de quote témoignage)
  // Mini-stats qualitatifs : Investissement / Durée / Statut / Approche
  const CAS = [
    {
      badge: t("cas_1_badge"),
      title: t("cas_1_title"),
      desc: t("cas_1_desc"),
      stats: [
        { label: "Investissement", value: "Capital structuré" },
        { label: "Durée", value: "Long terme" },
        { label: "Statut", value: "En partenariat" },
        { label: "Approche", value: "Méthodique" },
      ],
      Graphic: CaseGraphicNetwork,
    },
    {
      badge: t("cas_2_badge"),
      title: t("cas_2_title"),
      desc: t("cas_2_desc"),
      stats: [
        { label: "Investissement", value: "Capital + structuration" },
        { label: "Durée", value: "Moyen-long terme" },
        { label: "Statut", value: "Co-construction" },
        { label: "Approche", value: "Stratégique" },
      ],
      Graphic: CaseGraphicGrowth,
    },
    {
      badge: t("cas_3_badge"),
      title: t("cas_3_title"),
      desc: t("cas_3_desc"),
      stats: [
        { label: "Investissement", value: "Participation minoritaire" },
        { label: "Durée", value: "Phase amorçage" },
        { label: "Statut", value: "Partenaire actif" },
        { label: "Approche", value: "Sélective" },
      ],
      Graphic: CaseGraphicNetwork,
    },
  ];
  ...
  return (
    <>
      ...
      <main>
        ...
        {/* 1.5 TRUST BANDEAU — bento navy glass ──────────────────────── */}
        <section className="relative overflow-hidden bg-gradient-to-br from-nexus-blue-950 via-nexus-blue-900 to-nexus-blue-950 py-14 text-white lg:py-20">
          <div
            aria-hidden
          ...
          <div
            aria-hidden
            className="pointer-events-none absolute -right-40 bottom-0 h-[28rem] w-[28rem] rounded-full bg-nexus-blue-500/20 blur-[120px]"
          />
          <div
            aria-hidden
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-nexus-blue-950 via-nexus-blue-900 to-nexus-blue-950 py-20 text-white sm:py-24">
          ...
          <div
            aria-hidden
            className="pointer-events-none absolute -right-40 top-16 h-[32rem] w-[32rem] rounded-full bg-rose-500/12 blur-[140px]"
          />
          <div
            aria-hidden
            className="pointer-events-none absolute -left-40 bottom-0 h-[28rem] w-[28rem] rounded-full bg-nexus-blue-500/20 blur-[120px]"
          />
            ...
            <div className="grid gap-5 lg:grid-cols-3">
              ...
              {(() => {
                ...
                return (
                  <article
                    key={first.key}
                    className="group relative overflow-hidden rounded-3xl border border-white/10 bg-white/[0.04] p-7 ring-1 ring-rose-400/20 backdrop-blur-xl shadow-[inset_0_1px_0_0_rgba(255,255,255,0.06)] transition-all duration-300 ease-out hover:-translate-y-1 hover:border-rose-400/40 hover:bg-white/[0.06] sm:p-9 lg:col-span-2 lg:row-span-2"
                  >
                    <div
                      aria-hidden
                    ...
                    <div className="relative flex h-full flex-col gap-5">
                      <div className="flex items-center gap-4">
                        <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-rose-500/10 text-rose-300 ring-1 ring-rose-400/30 backdrop-blur transition-transform duration-300 ease-out group-hover:scale-105">
                          <Icon className="h-7 w-7" />
                        </div>
                        <span className="rounded-full border border-rose-400/30 bg-rose-500/10 px-3 py-1 text-[10px] font-bold uppercase tracking-[0.2em] text-rose-300 backdrop-blur">
                          {t("nepas_eyebrow")}
                        </span>
                      </div>
              ...
              {NEXUS_NEST_PAS.slice(1).map((item) => {
                ...
                return (
                  <article
                    key={item.key}
                    className="group relative overflow-hidden rounded-3xl border border-white/10 bg-white/[0.04] p-6 ring-1 ring-rose-400/20 backdrop-blur-xl shadow-[inset_0_1px_0_0_rgba(255,255,255,0.06)] transition-all duration-300 ease-out hover:-translate-y-1 hover:border-rose-400/40 hover:bg-white/[0.06]"
                  >
                    <div
                      aria-hidden
                    ...
                    <div className="relative flex gap-4">
                      <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-rose-500/10 text-rose-300 ring-1 ring-rose-400/30 backdrop-blur transition-transform duration-300 ease-out group-hover:scale-105">
              ...
              <div className="no-scrollbar flex snap-x snap-mandatory gap-4 overflow-x-auto scroll-px-4 px-4 pb-4">
                {MODELE.map((item, i) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`flex ${isMaster ? "h-14 w-14" : "h-11 w-11"} items-center justify-center rounded-2xl text-white shadow-sm ring-1 ring-white/10 ${item.iconBg}`}
                      >
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative flex h-full flex-col">
                      ...
                      <h3 className="mt-6 font-display text-2xl font-bold leading-tight text-white lg:text-3xl">
                        {t(`${m.key}_title`)}
                      </h3>
              ...
              {MODELE.slice(1).map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative">
                      <div
                        className={`flex h-11 w-11 items-center justify-center rounded-2xl text-white shadow-sm ring-1 ring-white/10 transition-transform duration-300 ease-out group-hover:scale-105 ${item.iconBg}`}
                      >
                        <Icon className="h-5 w-5" />
                      </div>
        ...
        {/* 4. 6 MODES D'ENGAGEMENT — navy glass bento ────────────────── */}
        <section className="relative overflow-hidden bg-gradient-to-br from-nexus-blue-950 via-nexus-blue-900 to-nexus-blue-950 py-20 text-white sm:py-24">
          <div
            aria-hidden
            className="pointer-events-none absolute inset-0 opacity-[0.55]"
                ...
                return (
                  ...
                  >
                    ...
                    {i === 4 && (
                      <div
                        aria-hidden
                        className="pointer-events-none absolute right-4 top-4 h-24 w-32 opacity-70"
                      >
                        <CaseGraphicGrowth />
                      </div>
                    )}
        ...
        {/* 5. INCUBATEUR NEXUS — navy renforcé glow + timeline 7 apports ── */}
        <section className="relative overflow-hidden bg-gradient-to-br from-nexus-blue-950 via-nexus-blue-900 to-nexus-blue-950 py-20 text-white sm:py-24 lg:py-28">
          ...
          <div
            aria-hidden
            className="pointer-events-none absolute -bottom-40 -left-40 h-[36rem] w-[36rem] rounded-full bg-nexus-blue-500/20 blur-[120px]"
          />
          <div
            aria-hidden
        ...
        {/* 6. MÉTHODOLOGIE — navy + numbers gradient orange clip-text ─── */}
        <section id="methodologie" className="relative overflow-hidden bg-gradient-to-br from-nexus-blue-950 via-nexus-blue-900 to-nexus-blue-950 py-20 text-white sm:py-24 lg:py-28">
          <div
            aria-hidden
            className="pointer-events-none absolute inset-0 opacity-[0.55]"
            style={DOT_GRID_DARK}
          ...
          <div className="relative mx-auto max-w-5xl px-4 lg:px-8">
            <div className="mx-auto mb-14 max-w-2xl text-center">
              ...
              <p className="mx-auto mt-5 max-w-xl text-base leading-relaxed text-slate-200">
                {t("metho_subtitle")}
              </p>
            </div>
        ...
        {/* 7. CRITÈRES DE SÉLECTION — navy glass split ───────────────── */}
        <section className="relative overflow-hidden bg-gradient-to-br from-nexus-blue-950 via-nexus-blue-900 to-nexus-blue-950 py-20 text-white sm:py-24">
          <div
            aria-hidden
            className="pointer-events-none absolute inset-0 opacity-[0.55]"
        ...
        {/* 8. CAS TYPES — 3 cards tech case study, factuel, sans quote ─ */}
        <section className="relative overflow-hidden bg-gradient-to-br from-nexus-blue-950 via-nexus-blue-900 to-nexus-blue-950 py-20 text-white sm:py-24">
          <div
            aria-hidden
            className="pointer-events-none absolute inset-0 opacity-[0.55]"
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="relative flex h-full flex-col">
                        ...
                        <div
                          aria-hidden
                          className="relative mt-5 h-24 w-full opacity-70"
                        >
                          <Graphic />
                        </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative flex h-full flex-col">
                      ...
                      <div
                        aria-hidden
                        className="relative mt-6 h-28 w-full opacity-70 transition-opacity duration-300 group-hover:opacity-100"
                      >
                        <Graphic />
                      </div>
        ...
        {/* 9. ENGAGEMENT TRANSPARENCE — navy glass asymétrique ─────── */}
        <section className="relative overflow-hidden bg-gradient-to-br from-nexus-blue-950 via-nexus-blue-900 to-nexus-blue-950 py-20 text-white sm:py-24">
          <div
            aria-hidden
            className="pointer-events-none absolute inset-0 opacity-[0.55]"
        ...
        {/* 10. CTA FINAL — hero card premium navy ──────────────────── */}
        <section className="relative overflow-hidden bg-gradient-to-br from-nexus-blue-950 via-nexus-blue-900 to-nexus-blue-950 py-20 text-white sm:py-24 lg:py-32">
          ...
          <div className="relative mx-auto max-w-4xl px-4 text-center lg:px-8">
            ...
            {/* Tagline éditoriale — sans guillemets fake-quote */}
