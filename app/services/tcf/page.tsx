        ...
        <section className="border-b border-line bg-surface py-12 lg:py-16">
          <div className="mx-auto max-w-4xl px-4 text-center lg:px-8">
            <p className="font-display text-display-sm text-ink lg:text-display-md">
              ...
              <span className="text-brand">la mesure documentée</span>{" "}
              de votre capacité à atteindre un niveau précis dans un délai précis.
            </p>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-6xl px-4 lg:px-8">
            <div className="mb-12 grid gap-10 lg:grid-cols-[1fr_2fr] lg:gap-16 lg:items-start">
              ...
              <ul className="space-y-5">
                {[
                  { title: "Diagnostic linguistique initial", desc: "Évaluation honnête de votre niveau actuel sur les quatre épreuves : compréhension orale et écrite, expression orale et écrite." },
                  { title: "Plan d'entraînement personnalisé", desc: "Programme adapté à vos points faibles, votre score visé et la date de passage cible." },
                  { title: "Simulations dans les conditions du test", desc: "Examens blancs chronométrés et corrigés, familiarisation totale avec le format réel." },
                  { title: "Inscription officielle au centre agréé", desc: "Réservation du créneau, accompagnement administratif et orientation le jour du passage." },
                ].map((item, i) => (
          ...
          <div className="mx-auto max-w-6xl px-4 lg:px-8">
            <div className="mx-auto mb-12 max-w-3xl text-center">
              ...
              <p className="mt-4 text-body-lg text-ink-muted">
                Pas de promesse de score — il dépend de votre travail et de la grille du jour.
                En revanche, voici ce que nous garantissons sur la préparation.
              </p>
            </div>
            <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
              {[
                { title: "Score visé objectivé", desc: "Niveau cible défini selon votre projet (admission universitaire, immigration économique, etc.)." },
                { title: "Méthode adaptée à votre profil", desc: "Pas de programme générique. Votre plan tient compte de votre niveau réel." },
                { title: "Familiarité totale avec le format", desc: "Aucune surprise le jour de l'examen — vous connaissez chaque épreuve." },
                { title: "Inscription au centre agréé", desc: "Démarches administratives prises en charge, créneau officiel sécurisé." },
              ].map((item, i) => (
