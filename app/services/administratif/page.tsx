    ...
    <>
      ...
      <main>
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-nexus-blue-950 via-nexus-blue-900 to-nexus-blue-950 py-20 text-white sm:py-24 lg:py-28">
          ...
          <div
            aria-hidden
            className="pointer-events-none absolute left-1/2 top-1/2 h-[24rem] w-[24rem] -translate-x-1/2 -translate-y-1/2 rounded-full bg-brand/10 blur-[120px]"
          />
          <div
            aria-hidden
                    ...
                    >
                      <div
                        className={`relative mx-auto h-[380px] w-full max-w-[18rem] overflow-hidden rounded-3xl border backdrop-blur-xl shadow-[inset_0_1px_0_0_rgba(255,255,255,0.08)] sm:h-[420px] sm:max-w-[20rem] ${
                          isMaster
                            ? "border-brand/50 bg-gradient-to-br from-brand/15 via-white/[0.05] to-white/[0.02] ring-1 ring-brand/30 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.10),0_24px_48px_-16px_rgba(185,151,96,0.45)]"
                      ...
                      >
                        ...
                        <div
                          className={`flex items-center justify-between border-b px-5 py-4 ${
                            isMaster
                              ? "border-brand/30 bg-gradient-to-r from-brand/15 to-transparent"
                          ...
                          <div className="flex items-center gap-2.5">
                            <div
                              className={`relative flex h-9 w-9 items-center justify-center rounded-xl ring-1 ${
                                isMaster
                                  ? "bg-brand text-on-brand shadow-[0_8px_20px_-8px_rgba(185,151,96,0.6)] ring-white/10"
                        ...
                        <div className="space-y-3 px-5 py-5">
                          <div className="flex items-center gap-2">
                            <div
                              className={`h-2.5 w-2.5 rounded-full ${
                                isMaster ? "bg-brand" : "bg-white/30"
                              }`}
                            />
                            <div
                              className={`h-2 w-2/3 rounded-full ${
                                isMaster
                                  ? "bg-gradient-to-r from-brand/60 to-brand/10"
                          ...
                          <div className="flex items-center gap-2 pt-2">
                            <div
                              className={`h-2.5 w-2.5 rounded-full ${
                                isMaster ? "bg-brand/70" : "bg-white/25"
                              }`}
                            />
                          ...
                          <div className="flex items-center gap-2 pt-2">
                            <div
                              className={`h-2.5 w-2.5 rounded-full ${
                                isMaster ? "bg-brand/50" : "bg-white/20"
                              }`}
                            />
                        ...
                        >
                          ...
                          <span
                            className={`text-[10px] font-bold tabular-nums ${
                              isMaster ? "text-brand" : "text-white/50"
                            }`}
                          >
                            v{i + 1}.0
                          </span>
                ...
                >
                  ...
                  <div className="relative flex h-full flex-col">
                    ...
                    <div className="mt-auto flex items-start justify-between gap-3 border-t border-white/10 pt-5">
                      <span className="bg-brand bg-clip-text text-[10px] font-bold uppercase leading-relaxed tracking-[0.18em] text-transparent">
                        {cas.result}
                      </span>
                      <ArrowRight className="mt-1 h-4 w-4 shrink-0 text-brand transition-transform duration-300 group-hover:translate-x-0.5" />
                    </div>
                  </div>
                </article>
              ))}
