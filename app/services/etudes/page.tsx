    ...
    <>
      ...
      <main>
              ...
              >
                <defs>
                  <linearGradient
                    ...
                    y2="100%"
                  >
                    <stop offset="0%" stopColor="rgba(185,151,96,0.10)" />
                  ...
                  <linearGradient
                    ...
                    y2="0%"
                  >
                    <stop offset="0%" stopColor="rgba(185,151,96,0.45)" />
                  ...
                  <linearGradient
                    ...
                    y2="50%"
                  >
                    <stop offset="0%" stopColor="rgba(185,151,96,0.05)" />
                    <stop offset="100%" stopColor="rgba(185,151,96,0.45)" />
                  </linearGradient>
                </defs>
                ...
                >
                  ...
                  <div
                    className={`relative z-10 flex items-center gap-2 rounded-full border px-3 py-1.5 backdrop-blur-md transition-all duration-300 ease-out cursor-pointer group-hover/city:-translate-y-0.5 ${
                      c.main
                        ? "border-brand/40 bg-brand/15 ring-1 ring-brand/20 shadow-[0_8px_20px_-8px_rgba(185,151,96,0.4)] group-hover/city:border-brand/70 group-hover/city:bg-brand/20"
                        : "border-white/15 bg-white/[0.06] ring-1 ring-white/5 group-hover/city:border-brand/40 group-hover/city:bg-white/[0.10]"
                    }`}
                  >
                    <MapPin
                      className={`h-3 w-3 shrink-0 ${
                        c.main ? "text-brand" : "text-white/70"
                      }`}
                    />
                  ...
                  <div
                    ...
                    role="tooltip"
                  >
                    <div className="overflow-hidden rounded-2xl border border-brand/40 bg-gradient-to-br from-brand/15 via-nexus-blue-950/95 to-nexus-blue-950/95 p-4 ring-1 ring-white/5 backdrop-blur-xl shadow-[inset_0_1px_0_0_rgba(255,255,255,0.08),0_24px_48px_-16px_rgba(185,151,96,0.40)]">
                      ...
                      <div className="mt-3 inline-flex items-center gap-1.5 rounded-full border border-brand/30 bg-brand/10 px-2 py-0.5 text-[9px] font-bold uppercase tracking-[0.16em] text-brand">
              ...
              {CITIES.map((c) => (
                <article
                  ...
                  className={`relative overflow-hidden rounded-2xl border p-4 backdrop-blur-xl ring-1 ring-white/5 ${
                    c.main
                      ? "border-brand/40 bg-gradient-to-br from-brand/10 via-white/[0.04] to-white/[0.02] shadow-[inset_0_1px_0_0_rgba(255,255,255,0.06),0_16px_36px_-16px_rgba(185,151,96,0.30)]"
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-nexus-blue-950 via-nexus-blue-900 to-nexus-blue-950 py-20 text-white sm:py-24">
          ...
          <div
            aria-hidden
            className="pointer-events-none absolute -left-40 top-1/4 h-[28rem] w-[28rem] rounded-full bg-brand/12 blur-[140px]"
          />
          <div
            aria-hidden
          ...
          <div className="relative mx-auto max-w-6xl px-4 lg:px-8">
            ...
            <div className="relative hidden lg:block">
              ...
              <div
                aria-hidden
                className="pointer-events-none absolute left-[8%] right-[8%] top-12 h-px bg-gradient-to-r from-transparent via-brand/50 to-transparent"
              />
                  ...
                  return (
                    <div key={step.num} className="group relative">
                      ...
                      <div className="relative mx-auto h-24 w-24">
                        ...
                        />
                        <div className="relative flex h-24 w-24 items-center justify-center rounded-3xl border border-brand/30 bg-nexus-blue-900/60 backdrop-blur-md font-display text-3xl font-bold tabular-nums shadow-[0_10px_28px_-10px_rgba(185,151,96,0.4)]">
                          <span className="bg-brand bg-clip-text text-transparent">
                            {step.num}
                          </span>
                        </div>
                      ...
                      <article className="relative mt-6 overflow-hidden rounded-3xl border border-white/10 bg-white/[0.04] p-6 ring-1 ring-white/5 backdrop-blur-xl shadow-[inset_0_1px_0_0_rgba(255,255,255,0.06)] transition-all duration-300 ease-out group-hover:-translate-y-1 group-hover:border-brand/40 group-hover:bg-white/[0.06]">
                        <div
                          aria-hidden
            ...
            <div className="relative lg:hidden">
              <div
                aria-hidden
                className="pointer-events-none absolute left-8 top-4 bottom-4 w-px bg-gradient-to-b from-brand/40 via-brand/20 to-transparent sm:left-12"
              />
                    ...
                    >
                      <div className="relative flex justify-center sm:justify-start">
                        <div className="relative">
                          ...
                          />
                          <span className="relative inline-flex h-16 w-16 items-center justify-center rounded-2xl border border-brand/30 bg-nexus-blue-900/60 backdrop-blur-md font-display text-2xl font-bold tabular-nums shadow-[0_10px_28px_-10px_rgba(185,151,96,0.4)] sm:h-20 sm:w-20 sm:text-3xl">
                            <span className="bg-brand bg-clip-text text-transparent">
                              {step.num}
                            </span>
                          </span>
                  ...
                  return (
                    <article
                      ...
                      className={`relative w-[85vw] shrink-0 snap-center overflow-hidden rounded-3xl border p-6 backdrop-blur-xl ring-1 ring-white/5 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.06)] ${
                        isHi
                          ? "border-brand/40 bg-gradient-to-br from-brand/15 via-white/[0.04] to-white/[0.02] shadow-[inset_0_1px_0_0_rgba(255,255,255,0.06),0_24px_48px_-16px_rgba(185,151,96,0.30)]"
                      ...
                      <div className="relative flex justify-center sm:justify-start">
                        <div className="relative">
                          <div
                            ...
                            className="absolute inset-0 rounded-3xl bg-brand/40 blur-md transition-all duration-500 group-hover:bg-brand/60"
                          />
                          <span className="relative inline-flex h-16 w-16 items-center justify-center rounded-3xl border border-brand/30 bg-nexus-blue-900/60 backdrop-blur-md font-display text-5xl font-bold tabular-nums shadow-[0_10px_28px_-10px_rgba(185,151,96,0.4)] sm:h-[7.5rem] sm:w-[7.5rem] sm:text-6xl">
                            <span className="bg-brand bg-clip-text text-transparent">
                              {etape.num}
                            </span>
                          </span>
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-nexus-blue-950 via-nexus-blue-900 to-nexus-blue-950 py-20 text-white sm:py-24">
          ...
          <div className="relative mx-auto max-w-6xl px-4 lg:px-8">
              ...
              {ETABLISSEMENTS.map((eta) => {
                ...
                return (
                  ...
                  >
                    ...
                    />
                    <div className="relative">
                      <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-brand text-on-brand shadow-[0_8px_20px_-8px_rgba(185,151,96,0.5)] ring-1 ring-white/10 transition-transform duration-300 ease-out group-hover:scale-105">
                        <Icon className="h-5 w-5" />
                      </div>
            ...
            {/* Bourses cross-link */}
            <div className="mt-10 overflow-hidden rounded-3xl border border-brand/30 bg-gradient-to-br from-brand/10 via-white/[0.04] to-white/[0.02] p-6 ring-1 ring-white/5 backdrop-blur-xl shadow-[inset_0_1px_0_0_rgba(255,255,255,0.06)] sm:p-7">
              <div className="flex items-start gap-4">
                <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-brand/15 text-brand ring-1 ring-brand/30 backdrop-blur">
