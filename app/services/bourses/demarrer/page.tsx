...
import { BoursesForm } from "@/components/bourses/BoursesForm";

export const metadata = {
  title: "Étude de faisabilité — Études au Canada | Nexus RCA",
  description:
...
export default function BoursesDemarrerPage() {
  return (
    <>
      <Navbar />
