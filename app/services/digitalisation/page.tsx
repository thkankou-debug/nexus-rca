        ...
        <section className="border-b border-line bg-surface py-12 lg:py-16">
          <div className="mx-auto max-w-4xl px-4 text-center lg:px-8">
            <p className="font-display text-display-sm text-ink lg:text-display-md">
              ...
              <span className="text-brand">un outil opérationnel</span>{" "}
          ...
          <div className="mx-auto max-w-6xl px-4 lg:px-8">
            <div className="mb-12 grid gap-10 lg:grid-cols-[1fr_2fr] lg:gap-16 lg:items-start">
              ...
              <ul className="space-y-5">
                {[
                  { title: "Audit du besoin opérationnel", desc: "Compréhension du métier, des flux et des points de friction actuels avant toute proposition." },
                  { title: "Cadrage périmètre et budget", desc: "Définition précise des livrables, des fonctionnalités et du devis fixe avant tout démarrage." },
                  { title: "Réalisation aux standards", desc: "Site web, intégration WhatsApp Business, formulaires, automatisations selon le pack retenu." },
                  { title: "Livraison et formation", desc: "Remise documentée + session de prise en main pour autonomie complète de l'équipe." },
                ].map((item, i) => (
          ...
          <div className="mx-auto max-w-6xl px-4 lg:px-8">
            <div className="mx-auto mb-12 max-w-3xl text-center">
              ...
              <p className="mt-4 text-body-lg text-ink-muted">
                Un outil utilisé au quotidien par votre équipe, pas un site qu&apos;on regarde puis qu&apos;on oublie.
              </p>
            </div>
            <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
              {[
                { title: "Outil aligné au métier", desc: "Pas de gadget. Des fonctionnalités utilisées au quotidien." },
                { title: "Devis fixe sans dépassement", desc: "Vous savez exactement ce que ça coûte avant de signer." },
                { title: "Documentation transmise", desc: "Codes d'accès, procédures et points de contrôle remis à votre équipe." },
                { title: "Autonomie opérationnelle", desc: "Vous pouvez faire tourner l'outil sans dépendre de nous." },
              ].map((item, i) => (
