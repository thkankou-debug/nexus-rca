        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-nexus-blue-950 via-nexus-blue-900 to-nexus-blue-950 py-20 text-white sm:py-24 lg:py-28">
          ...
          <div className="relative mx-auto max-w-6xl px-4 lg:px-8">
            ...
            <div className="relative mx-auto max-w-5xl">
              <div
                aria-hidden
                className="pointer-events-none absolute -inset-4 rounded-[2rem] bg-gradient-to-br from-brand/10 via-transparent to-nexus-blue-500/10 blur-2xl"
              />
              <div className="relative overflow-hidden rounded-3xl border border-white/15 bg-white/[0.04] ring-1 ring-white/5 backdrop-blur-xl shadow-[inset_0_1px_0_0_rgba(255,255,255,0.06),0_40px_80px_-30px_rgba(0,0,0,0.5)]">
                ...
                <div className="flex items-end gap-1 border-b border-white/10 bg-white/[0.02] px-3 pt-2 sm:px-4">
                  <div className="flex items-center gap-2 rounded-t-xl border border-b-0 border-white/15 bg-nexus-blue-900/60 px-3 py-2 sm:px-4">
                    <span className="h-2.5 w-2.5 rounded-full bg-brand shadow-[0_0_8px_rgba(185,151,96,0.5)]" />
                ...
                <div className="relative bg-gradient-to-br from-nexus-blue-950 via-nexus-blue-950 to-nexus-blue-900 p-5 sm:p-8">
                  ...
                  <div className="relative flex items-center justify-between border-b border-white/10 pb-4">
                    <div className="flex items-center gap-2.5">
                      <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-brand text-on-brand shadow-[0_8px_20px_-8px_rgba(185,151,96,0.5)]">
                    ...
                    <div className="rounded-full bg-brand px-3 py-1.5 text-[10px] font-bold uppercase tracking-[0.18em] text-on-brand shadow-[0_6px_16px_-6px_rgba(185,151,96,0.6)]">
                      Réserver
                    </div>
                  </div>
                  ...
                  <div className="relative mt-6 grid gap-5 lg:grid-cols-[1.2fr_1fr] lg:items-center">
                    <div>
                      <span className="inline-block bg-brand bg-clip-text text-[9px] font-bold uppercase tracking-[0.22em] text-transparent">
                        Bienvenue chez vous
                      </span>
                      ...
                      <div className="mt-4 flex items-center gap-2">
                        <span className="rounded-lg bg-brand px-3 py-1.5 text-[10px] font-bold text-on-brand">
                          Démarrer
                        </span>
                    ...
                    <div className="hidden h-32 items-center justify-center rounded-2xl border border-white/10 bg-gradient-to-br from-brand/15 via-white/[0.04] to-nexus-blue-500/10 backdrop-blur lg:flex">
                      <Globe className="h-12 w-12 text-brand/70" />
                    </div>
                  </div>
              ...
              {TOOLS.map((tool) => {
                ...
                return (
                  ...
                  >
                    ...
                    />
                    <div className="relative">
                      <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-brand text-on-brand shadow-[0_8px_20px_-8px_rgba(185,151,96,0.5)] ring-1 ring-white/10 transition-transform duration-300 ease-out group-hover:scale-105">
                        <Icon className="h-5 w-5" />
                      </div>
