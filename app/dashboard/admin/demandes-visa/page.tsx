...
export const metadata = {
  title: "Demandes visa express | Admin",
};

export const dynamic = "force-dynamic";

export default async function AdminDemandesVisaPage() {
  ...
  if (error) {
    console.error("[demandes-visa admin] error:", error.message);
  }
      ...
      <header className="mb-10 flex flex-wrap items-center gap-4">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-1 text-sm text-slate-500">
            Soumissions reçues via le formulaire express public.
          </p>
        </div>
      </header>
