...
export const metadata = {
  title: "Nouvelle fiche de paie | Admin RH",
};

export const dynamic = "force-dynamic";

export default async function AdminNouvelleFichePaiePage() {
  ...
  return (
    <DashboardShell profile={profile}>
      ...
      <div className="mb-6 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-slate-600">
            Créez un brouillon. Vous pourrez le soumettre pour validation au
            Super-Admin.
          </p>
        </div>
      </div>
      ...
      <Suspense fallback={null}>
        <NewPayslipClient basePath="/dashboard/admin/rh" />
      </Suspense>
    </DashboardShell>
  );
}
