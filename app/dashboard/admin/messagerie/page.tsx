    ...
    <DashboardShell profile={profile}>
      ...
      <div className="mb-8 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="mt-1 text-slate-600">
            Conversations équipe et clients sur la même plateforme.
          </p>
        </div>
      </div>
      ...
      <section className="rounded-3xl border-2 border-dashed border-line bg-surface-elevated p-10 text-center shadow-elev-1">
        ...
        <p className="mx-auto mt-3 max-w-xl text-body-sm text-ink-muted">
          La messagerie interne sera livrée en phase 6 du roadmap : threads
          par dossier (client ↔ agent assigné), threads d'équipe
          (agents ↔ admin), notifications e-mail via Resend, intégration
