      ...
      <div className="mb-8 flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex gap-2">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-full bg-brand px-4 py-2.5 text-sm font-semibold text-on-brand shadow-lg hover:bg-brand-hover"
          >
          ...
          {list.map((d) => {
            ...
            return (
              <Link
                ...
                className="group block rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition hover:-translate-y-0.5 hover:border-brand/30 hover:shadow-md"
              >
                <div className="flex flex-wrap items-center gap-2">
                  <span className="rounded-md bg-nexus-blue-50 px-2 py-0.5 font-mono text-[11px] font-bold text-brand-hover">
                    {ref}
                  </span>
                ...
                <div className="mt-4 flex items-center justify-between border-t border-slate-100 pt-3">
                  ...
                  <span className="inline-flex items-center gap-1 text-[11px] font-bold uppercase tracking-wider text-slate-400 transition group-hover:text-brand-hover">
                    Ouvrir
