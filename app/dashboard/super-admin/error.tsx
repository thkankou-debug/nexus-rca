  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#f4f6fb] px-6">
      <div className="max-w-md rounded-2xl border border-[#eceef6] bg-white p-6">
        <h1 className="text-lg font-bold text-[#1c2033]">Chargement impossible</h1>
        <p className="mt-2 text-sm text-[#8b93a7]">{error.message || "Erreur inattendue. Aucun chiffre de remplacement."}</p>
