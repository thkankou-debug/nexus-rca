...
export default async function SuperAdminCommissionsPage() {
  ...
  if (error) console.error("[SUPER_ADMIN_COMMISSIONS] chargement:", error.message);
  ...
  return (
    <DashboardShell profile={profile}>
      ...
      <div className="mb-8 flex items-center gap-3">
        ...
        <div>
          <h1 className="font-display text-3xl font-bold text-nexus-blue-950">Commissions</h1>
          <p className="mt-1 text-slate-600">Commissions de tous les agents.</p>
        </div>
      </div>

      <CommissionsManager initialCommissions={commissions} canCreate />
    </DashboardShell>
  );
}
