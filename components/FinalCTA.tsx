...
export function FinalCTA() {
  return (
    <section className="relative overflow-hidden bg-nexus-blue-950 py-24 text-white sm:py-28 lg:py-32">
      ...
      >
        <defs>
          ...
          <linearGradient id="conv-grad-3" x1="0%" y1="100%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="rgba(185,151,96,0)" />
            <stop offset="50%" stopColor="rgba(185,151,96,0.4)" />
            <stop offset="100%" stopColor="rgba(185,151,96,0)" />
          </linearGradient>
        </defs>
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute -top-32 -right-32 h-[36rem] w-[36rem] rounded-full bg-brand/20 blur-[140px]"
      />
      <div
        aria-hidden
        className="pointer-events-none absolute -bottom-40 -left-32 h-[36rem] w-[36rem] rounded-full bg-nexus-blue-500/20 blur-[140px]"
      />
      <div
        aria-hidden
        className="pointer-events-none absolute left-1/2 top-1/2 h-[20rem] w-[20rem] -translate-x-1/2 -translate-y-1/2 rounded-full bg-brand/15 blur-[120px] animate-pulse"
      />
      {/* === Hairlines === */}
      <div
        aria-hidden
      ...
      <div className="relative mx-auto max-w-3xl px-4 text-center lg:px-8">
        {/* === Badge pulsant === */}
        <span className="inline-flex items-center gap-2 rounded-full border border-brand/30 bg-brand/10 px-3.5 py-1.5 text-[10px] font-bold uppercase tracking-[0.24em] text-brand backdrop-blur-md">
        ...
        <h2 className="mt-6 font-display text-4xl font-bold leading-[1.05] tracking-tight text-white sm:text-5xl lg:text-6xl">
          Confiez-nous
          <br />
          <span className="text-brand">votre prochain dossier.</span>
        </h2>
...
function TrustItem({
  ...
  return (
    <div className="group flex items-center justify-center gap-3 rounded-xl border border-white/10 bg-white/[0.04] px-4 py-3 backdrop-blur-md transition-all duration-300 hover:border-brand/40 hover:bg-white/[0.07]">
      <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-brand/15 ring-1 ring-brand/30 transition-transform duration-300 group-hover:scale-110">
