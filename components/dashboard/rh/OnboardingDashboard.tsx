    ...
    >
      ...
      <div className="mt-3 flex flex-wrap gap-1.5">
        ...
        {done ? (
          ...
          <span className="inline-flex items-center gap-1 rounded-full bg-brand-subtle px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider text-brand-hover ring-1 ring-brand/30">
...
function NoOnboardingCard({
  ...
  return (
    <div className="rounded-3xl border border-dashed border-slate-300 bg-white p-5 shadow-sm ring-1 ring-slate-100/80 transition hover:border-brand/40">
      <div className="flex items-start gap-3">
      ...
      <button
        type="button"
        onClick={onStart}
        className="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-brand px-4 py-2.5 text-sm font-semibold text-on-brand shadow-sm transition hover:bg-brand-hover"
      >
