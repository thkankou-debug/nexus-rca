...
const NAV_BY_ROLE: Record<UserRole, NavGroup[]> = {
  ...
  agent: [
    ...
    {
      label: "Dossiers par catégorie",
      items: [
        { href: "/dashboard/agent/dossiers", label: "Toutes les catégories", icon: FolderOpen },
        { href: "/dashboard/agent/dossiers/visa", label: "Visa", icon: Plane },
        { href: "/dashboard/agent/dossiers/etudes_bourses", label: "Études & Bourses", icon: Award },
        { href: "/dashboard/agent/dossiers/billets_hotels", label: "Billets & Hôtels", icon: CalendarDays },
        { href: "/dashboard/agent/dossiers/assurances", label: "Assurances", icon: ShieldCheck },
        { href: "/dashboard/agent/dossiers/financement_incubateur", label: "Financement", icon: Briefcase },
        { href: "/dashboard/agent/dossiers/digitalisation", label: "Digitalisation", icon: Rocket },
        { href: "/dashboard/agent/dossiers/recouvrement", label: "Recouvrement", icon: Library },
        { href: "/dashboard/agent/dossiers/transferts", label: "Transferts", icon: Send },
        { href: "/dashboard/agent/dossiers/autres", label: "Autres dossiers", icon: Inbox },
      ],
    },
    {
      label: "Mon activité",
      items: [
        ...
        { href: "/dashboard/agent/demandes", label: "Mes dossiers (vue legacy)", icon: FileText },
  ...
  admin: [
    ...
    },
    {
      label: "Dossiers par catégorie",
      items: [
        { href: "/dashboard/admin/dossiers", label: "Toutes les catégories", icon: FolderOpen },
        { href: "/dashboard/admin/dossiers/visa", label: "Visa", icon: Plane },
        { href: "/dashboard/admin/dossiers/etudes_bourses", label: "Études & Bourses", icon: Award },
        { href: "/dashboard/admin/dossiers/billets_hotels", label: "Billets & Hôtels", icon: CalendarDays },
        { href: "/dashboard/admin/dossiers/assurances", label: "Assurances", icon: ShieldCheck },
        { href: "/dashboard/admin/dossiers/financement_incubateur", label: "Financement", icon: Briefcase },
        { href: "/dashboard/admin/dossiers/digitalisation", label: "Digitalisation", icon: Rocket },
        { href: "/dashboard/admin/dossiers/recouvrement", label: "Recouvrement", icon: Library },
        { href: "/dashboard/admin/dossiers/transferts", label: "Transferts", icon: Send },
        { href: "/dashboard/admin/dossiers/autres", label: "Autres dossiers", icon: Inbox },
      ],
    },
    {
      label: "Opérations",
      items: [
        { href: "/dashboard/admin/demandes", label: "Demandes (vue legacy)", icon: FileText },
  ...
  super_admin: [
    ...
    },
    {
      label: "Dossiers par catégorie",
      items: [
        { href: "/dashboard/super-admin/dossiers", label: "Toutes les catégories", icon: FolderOpen },
        { href: "/dashboard/super-admin/dossiers/visa", label: "Visa", icon: Plane },
        { href: "/dashboard/super-admin/dossiers/etudes_bourses", label: "Études & Bourses", icon: Award },
        { href: "/dashboard/super-admin/dossiers/billets_hotels", label: "Billets & Hôtels", icon: CalendarDays },
        { href: "/dashboard/super-admin/dossiers/assurances", label: "Assurances", icon: ShieldCheck },
        { href: "/dashboard/super-admin/dossiers/financement_incubateur", label: "Financement", icon: Briefcase },
        { href: "/dashboard/super-admin/dossiers/digitalisation", label: "Digitalisation", icon: Rocket },
        { href: "/dashboard/super-admin/dossiers/recouvrement", label: "Recouvrement", icon: Library },
        { href: "/dashboard/super-admin/dossiers/transferts", label: "Transferts", icon: Send },
        { href: "/dashboard/super-admin/dossiers/autres", label: "Autres dossiers", icon: Inbox },
        { href: "/dashboard/super-admin/agents", label: "Spécialités agents", icon: Briefcase, highlight: true },
      ],
    },
    {
      label: "Opérations",
      items: [
        ...
        { href: "/dashboard/super-admin/demandes", label: "Demandes (vue legacy)", icon: FileText },
