    ...
    <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
      ...
      <div className="space-y-2 p-4">
        ...
        <a
          ...
          className="flex items-center justify-between rounded-xl border border-brand/30 bg-brand-subtle p-3 transition hover:-translate-y-0.5 hover:bg-brand-subtle hover:shadow-md"
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-bold text-brand-hover">Email</p>
              <p className="text-xs text-brand-hover">Pour le détail</p>
            </div>
          </div>
          <span className="hidden text-xs font-semibold text-brand-hover sm:inline">
            Écrire
          </span>
        </a>
      </div>
