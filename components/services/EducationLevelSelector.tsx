...
export function EducationLevelSelector() {
  ...
  return (
    <div className="relative">
          ...
          return (
            <button
              ...
              className={`group relative overflow-hidden rounded-2xl border px-3 py-4 text-center backdrop-blur-xl shadow-[inset_0_1px_0_0_rgba(255,255,255,0.06)] transition-all duration-300 ease-out ${
                isActive
                  ? "border-brand/60 bg-gradient-to-br from-brand/20 via-white/[0.06] to-white/[0.02] ring-1 ring-brand/30 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.06),0_18px_40px_-16px_rgba(185,151,96,0.45)]"
                  : "border-white/10 bg-white/[0.04] ring-1 ring-white/5 hover:-translate-y-0.5 hover:border-brand/40 hover:bg-white/[0.06]"
              }`}
            >
              <div
                aria-hidden
              ...
              <div className="relative flex flex-col items-center gap-2">
                <span
                  className={`flex h-9 w-9 items-center justify-center rounded-xl ring-1 transition-transform duration-300 ease-out ${
                    isActive
                      ? "scale-110 bg-brand text-on-brand shadow-[0_8px_20px_-8px_rgba(185,151,96,0.6)] ring-white/10"
                      : "bg-white/[0.04] text-brand ring-white/10 group-hover:scale-105"
                  }`}
                >
      ...
      <article
        key={active}
        className="relative mt-7 overflow-hidden rounded-3xl border border-brand/40 bg-gradient-to-br from-brand/12 via-white/[0.04] to-white/[0.02] p-6 ring-1 ring-white/5 backdrop-blur-xl shadow-[inset_0_1px_0_0_rgba(255,255,255,0.06),0_24px_48px_-16px_rgba(185,151,96,0.30)] sm:p-8"
      >
        <div
          aria-hidden
