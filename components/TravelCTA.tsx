    ...
    <section className="relative overflow-hidden bg-nexus-blue-950 py-24 sm:py-28 lg:py-32">
      ...
      >
        <svg viewBox="0 0 600 600" fill="none" className="h-full w-full animate-[float_12s_ease-in-out_infinite]">
          <circle cx="300" cy="300" r="280" stroke="rgba(185,151,96,0.5)" strokeWidth="0.5" />
          <circle cx="300" cy="300" r="220" stroke="rgba(255,255,255,0.3)" strokeWidth="0.5" />
          <circle cx="300" cy="300" r="160" stroke="rgba(185,151,96,0.3)" strokeWidth="0.5" />
          ...
          <path d="M 380 220 Q 500 280 420 380" stroke="rgba(185,151,96,0.4)" strokeWidth="0.8" strokeDasharray="4 4" fill="none">
            <animate attributeName="stroke-dashoffset" values="0;-40" dur="3.5s" repeatCount="indefinite" />
          </path>
          <path d="M 160 380 Q 290 500 420 380" stroke="rgba(185,151,96,0.3)" strokeWidth="0.8" strokeDasharray="4 4" fill="none">
      ...
      <div className="relative mx-auto max-w-6xl px-4 lg:px-8">
        ...
        <div className="mb-14 max-w-3xl">
          ...
          <h2 className="mt-5 font-display text-3xl font-bold leading-[1.1] tracking-tight text-white sm:text-4xl lg:text-5xl">
            Le monde,
            <br />
            <span className="text-brand">à portée de votre dossier.</span>
          </h2>
        ...
        <div className="grid gap-5 lg:grid-cols-2 lg:gap-6">
          ...
          >
            <div
              aria-hidden
              className="pointer-events-none absolute -right-16 -top-16 h-56 w-56 rounded-full bg-brand/20 blur-[100px] transition-all duration-700 group-hover/card:bg-brand/40"
            />
            {/* Icône avion XXL en arrière-plan */}
            <Plane
              aria-hidden
              className="pointer-events-none absolute -right-6 -bottom-6 h-48 w-48 -rotate-12 text-white/[0.04] transition-all duration-700 group-hover/card:rotate-0 group-hover/card:text-brand/[0.10]"
            />

            <div className="relative">
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-brand/15 ring-1 ring-brand/30 backdrop-blur-md transition-transform duration-500 group-hover/card:scale-110 group-hover/card:rotate-6">
                <Plane className="h-5 w-5 text-brand" />
              </div>
              <p className="mt-6 text-[10px] font-bold uppercase tracking-[0.24em] text-brand">
                Vols & itinéraires
              </p>
          ...
          >
            ...
            <div className="relative">
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-nexus-blue-950/10 ring-1 ring-nexus-blue-950/25 backdrop-blur-md transition-transform duration-500 group-hover/card:scale-110">
                <Hotel className="h-5 w-5 text-on-brand" />
              </div>
              <p className="mt-6 text-[10px] font-bold uppercase tracking-[0.24em] text-on-brand/85">
                Hôtellerie & hébergement
              </p>
              <h3 className="mt-2 font-display text-2xl font-bold leading-tight tracking-tight text-on-brand sm:text-3xl">
                Réservez l&apos;adresse qui s&apos;impose.
              </h3>
              <div
                aria-hidden
                className="my-4 h-px w-12 bg-gradient-to-r from-nexus-blue-950/60 to-transparent"
              />
              <p className="text-sm leading-relaxed text-on-brand/90 sm:text-base">
