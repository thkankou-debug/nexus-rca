  ...
  return (
    <section className="relative overflow-hidden bg-[#070C1A] py-24 sm:py-28 lg:py-32">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(135deg, rgba(185,151,96,0.05) 0%, transparent 35%, transparent 65%, rgba(56,80,160,0.07) 100%)",
        }}
      />
      {/* === Orbes ambiantes lumineuses === */}
      <div
        aria-hidden
        className="pointer-events-none absolute -left-32 top-0 h-[28rem] w-[28rem] rounded-full bg-brand/15 blur-[120px]"
      />
      <div
        aria-hidden
            ...
            {PHASES.map((phase) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    aria-hidden
                    className="pointer-events-none absolute -right-16 -top-16 h-40 w-40 rounded-full bg-brand/0 blur-3xl transition-all duration-700 group-hover:bg-brand/35"
                  />
                  ...
                  <div className="relative">
                    ...
                    <div className="relative inline-flex">
                      ...
                      />
                      <div className="relative flex h-12 w-12 items-center justify-center rounded-2xl bg-brand text-on-brand shadow-[0_8px_24px_-8px_rgba(185,151,96,0.7)] ring-1 ring-white/15">
